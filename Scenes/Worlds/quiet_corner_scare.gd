...
@onready var cubicle_wall: StaticBody3D = $"../../Cubicle_Door"
@onready var monitor: RigidBody3D = $"../../NavigationRegion3D/Objects/Desk37/GrabableObjectTemplate"
@onready var screen_light_2: SpotLight3D = $"../../NavigationRegion3D/Objects/Desk37/GrabableObjectTemplate/ComputerOn/ScreenLight"
